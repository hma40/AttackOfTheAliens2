...
public class attack_of_the_aliens_2 extends PApplet {
...
public void menuScripts() {
  ...
  if (menuSeconds%300>145&&menuSeconds%300<175) {
    if (menuRandom==0) {
      makeTera(1, 1000, 280, 0.5f, true);
      makePico(1, 1400, 280, 0.5f, true, true, true);
      makeNano(1, 1200, 280, 0.5f, 1, true, true);
...
public void gameScripts() {
  ...
  if (ingameSeconds<425) {
    ...
    if (currentDay<7&&ingameSeconds<900&&!callMuted) {
      ...
      textSize(30);
      if (ran==69) {
        text("Shut up", 112.5f, 162.5f);
      } else {
        text("Mute call", 112.5f, 162.5f);
      }
      textAlign(LEFT);
    }
    if (callMuted) {
...
public void makePostIt(int x, int y) {
  stroke(0);
  strokeWeight(3);
  fill(255);
  rect(x, y, 30, 60);
...
public void buildOffice() {
  ...
  if (flashlight==true) {
    ...
    if (newPico==3||newPico==4) {
      ...
      makeGiga(0.5f, 700, 485, 0.5f, true);
      rotate(PI);
      makeGiga(0.5f, -700, -670, 0.1f, true);
      rotate(PI);
      makeNewGiga(0.5f, 770, 485, 1, true);
    } else if (giga==1&&tera==2) {
      makeGiga(0.5f, 750, 485, 0.5f, true);
      makeTera(0.5f, 800, 500, 0.5f, true);
      rotate(PI);
      makeGiga(0.5f, -750, -670, 0.1f, true);
      makeTera(0.5f, -800, -685, 0.1f, true);
      rotate(PI);
    } else if (giga==1) {
      makeGiga(0.5f, 750, 485, 0.5f, true);
      rotate(PI);
      ...
      makePico(0.5f, 750, 485, 0.5f, false, false, true);
      rotate(PI);
      makePico(0.5f, -750, -670, 0.5f, false, false, true);
      rotate(PI);
    } else if (tera==2) {
      makeTera(0.5f, 750, 485, 0.5f, true);
      rotate(PI);
      makeTera(0.5f, -750, -670, 0.1f, true);
      rotate(PI);
    } else if (newGiga==3) {
      makeNewGiga(0.5f, 750, 485, 1, true);
    } else if (newPico==2) {
      makeNewPico(0.5f, 750, 485, 1, false, true);
      rotate(PI);
      makeNewPico(0.5f, -750, -670, 1, false, true);
      rotate(PI);
    } else if (goldenAlienChance==1) {
      flashCounter2++;
      makeGoldenAlien(1, 750, 485, 0.5f, true, false);
    }
  }
  strokeWeight(2);
  stroke(0);
  ...
  fill(255, 0, 0);
  rect(60, 200, 330, 230);
  makeNewTera(0.5f, 120, 270, 1, 0, 0, false, true);
  makeNewNano(0.5f, 220, 270, 1, 0, false, true);
  makeNewPico(0.5f, 320, 270, 1, false, true);
  textAlign(CENTER, CENTER);
  textSize(50);
  fill(255);
  text("Party!", 220, 392);
  ...
  if (lLight==true) {
    if (newNano==5) {
      strokeWeight(7.5f);
      stroke(139, 69, 19);
      line(125-100*0.75f*cos(4*PI/3), 675-100*0.75f*sin(4*PI/3), 125-100*0.75f*cos(4*PI/3), 675-100*0.75f*sin(4*PI/3)+35);
      line(125-100*0.75f*cos(5*PI/3), 675-100*0.75f*sin(5*PI/3), 125-100*0.75f*cos(5*PI/3), 675-100*0.75f*sin(5*PI/3)+44);
      makeNewNano(0.75f, 125, 675, 1, 1, false, false);
    } else if (gobo==5) {
      strokeWeight(7.5f);
      stroke(0, 255, 255);
      line(125-100*0.75f*cos(4*PI/3), 675-100*0.75f*sin(4*PI/3), 125-100*0.75f*cos(4*PI/3), 675-100*0.75f*sin(4*PI/3)+35);
      line(125-100*0.75f*cos(5*PI/3), 675-100*0.75f*sin(5*PI/3), 125-100*0.75f*cos(5*PI/3), 675-100*0.75f*sin(5*PI/3)+44);
      makeGobo(0.75f, 125, 675, 1, "", false, false);
    }
  }
  if (rLight==true) {
    if (newTera==5||newTera==6) {
      strokeWeight(7.5f);
      stroke(138, 43, 226);
      line(1375-100*0.75f*cos(4*PI/3), 675-100*0.75f*sin(4*PI/3), 1375-100*0.75f*cos(4*PI/3), 675-100*0.75f*sin(4*PI/3)+44);
      line(1375-100*0.75f*cos(5*PI/3), 675-100*0.75f*sin(5*PI/3), 1375-100*0.75f*cos(5*PI/3), 675-100*0.75f*sin(5*PI/3)+35);
      makeNewTera(0.75f, 1375, 675, 1, 1, 0, false, false);
    } else if (newGiga==6) {
      makeNewGiga(0.75f, 1375, 675, 1, false);
    }
  }
  noFill();
  noStroke();
  ...
  if (someoneInOffice) {
    if (pico>4) {
      makePico(2, 750, 400, 0.5f, false, true, true);
    } else if (newPico>4) {
      makeNewPico(2, 750, 400, 1, false, true);
    } else if (tera>5) {
      makeTera(2, 750, 400, 0.5f, true);
    } else if (nano>4) {
      makeNano(2, 750, 400, 0.5f, 1, false, true);
    }
  }
  if (maskTimer[18]>0&&maskTimer[18]<60) {
    makeGoldenAlien(2, 750, 400, 0.5f-0.5f*maskTimer[18]/60, false, true);
  }
  if (maskTimer[18]>60) {
    maskTimer[18]=0;
  }
...
public void makeBalloon(int x, int y) {
  strokeWeight(3);
  stroke(0);
  ellipse(x, y, 80, 100); 
  line(x, y+50, x, y+150);
...
public void makeStar(float x, float y, float h, float w) {
  beginShape();
  vertex(x, y-h); 
...
public void cameraScripts() {  
  ...
  if (camLeftOff==5) {
    ...
    if (musicBox>60) {
      ...
      noStroke();
      rect(1275, 201.5f, 50, 98.5f);
    }
    if (musicBox<1) {
      noStroke();
      rect(1226.5f, 201.5f, 50, 98.5f);
    }
  ...
  if (!flashlight&&camLeftOff==1) {
    if (!(newPico==0&&newTera!=0&&newNano!=0&&newPicoChance==1)) {
      ...
      if (newTera==0&&newPico==0&&newNano==0) {
        makeNewTera(1, 650, 400, 0.2f, 1, 1, false, true);
        makeNewPico(1, 875, 400, 0.2f, false, true);
        fill(0);
        ellipse(825, 380, 9, 9);
        ellipse(905, 380, 9, 9);
        makeNewNano(1, 1100, 400, 0.2f, 0, false, true);
        ...
        ellipse(825, 380, 9, 9);
        ellipse(905, 380, 9, 9);
        makeNewNano(1, 1100, 400, 0.2f, 1, false, true);
      } else if (newPico==0) {
        makeNewPico(1, 875, 400, 0.2f, false, true);
        fill(0);
        ellipse(825, 380, 9, 9);
  ...
  if (flashlight==true) {
    ...
    if (camLeftOff==2) {
      ...
      if (tera==1&&newNano!=1&&pico!=1) {
        makeTera(0.5f, 800, 295, 0.5f, true);
      }
      fill(125);
      ...
      if (newNano==1) {
        makeNewNano(1.5f, 728, 312, 0.25f, 1, false, true);
      }
      if (pico==1&&newNano!=1) {
        makePico(1, 736, 365, 0.5f, true, true, true);
      }
    }
    if (camLeftOff==3) {
      fill(0, 0, 50);
      ...
      if (nano==1) {
        makeNano(1, 680, 154, 0.25f, 0, false, true);
      } else if (newNano==2) {
        makeNewNano(1, 959, 342, 0.5f, 0, false, true);
      } else if (newTera==2) {
        makeNewTera(0.5f, 700, 394, 0.5f, 0, 0, false, false);
      }
    }
    if (camLeftOff==4) {
      fill(50);
      ...
      if (newTera==3) {
        fill(0);
        rect(796, 150, 120, 200);
        makeNewTera(0.5f, 855, 206, 0, 0, 0, false, true);
      } else if (nano==2) {
        makeNano(1, 737, 205, 0.5f, 1, false, true);
      }
      if (newGiga==4) {
    ...
    if (camLeftOff==5) {
      ...
      if (puppet==1) {
        makePuppet(0.5f, 795, 50, 0.5f, true, false);
        fill(50, 0, 0);
        stroke(0);
        strokeWeight(3);
        rect(763, 51, 50, 50);
    ...
    if (camLeftOff==6) {
      ...
      if (pico==0&&tera==0&&nano==0) {
        makeTera(0.5f, 761, 270, 0.4f, true);
        rotate(PI/6);
        makeNano(0.5f, 865, 158, 0.4f, 0, true, false);
        strokeWeight(10*0.5f);
        stroke(0, 255*0.4f, 0);
        line(865-100*0.4f*cos(4*PI/3), 158-100*0.4f*sin(4*PI/3), 865-100*0.4f*cos(4*PI/3), 158-100*0.4f*sin(4*PI/3)+50*0.4f);
        line(865-100*0.4f*cos(5*PI/3), 158-100*0.4f*sin(5*PI/3), 865-100*0.4f*cos(5*PI/3), 158-100*0.4f*sin(5*PI/3)+40*0.4f);
        rotate(-PI/3);
        makePico(0.5f, 610, 984, 0.4f, true, false, true);
        rotate(PI/6);
      } else if (pico==0&&nano==0) {
        rotate(PI/6);
        makeNano(0.5f, 865, 158, 0.4f, 1, true, false);
        strokeWeight(10*0.5f);
        stroke(0, 255*0.4f, 0);
        line(865-100*0.4f*cos(4*PI/3), 158-100*0.4f*sin(4*PI/3), 865-100*0.4f*cos(4*PI/3), 158-100*0.4f*sin(4*PI/3)+50*0.4f);
        line(865-100*0.4f*cos(5*PI/3), 158-100*0.4f*sin(5*PI/3), 865-100*0.4f*cos(5*PI/3), 158-100*0.4f*sin(5*PI/3)+40*0.4f);
        ...
        rotate(-PI/6);
        makePico(0.5f, 610, 984, 0.4f, true, true, true);
        rotate(PI/6);
      } else if (giga==0) {
        makeGiga(0.5f, 900, 400, 0.4f, true);
      }
      noStroke();
      noFill();
    }
    if (camLeftOff==7) {
      ...
      makeBalloon(664, 253);
      if (pico==2) {
        makePico(1, 822, 337, 0.5f, false, false, true);
      } else if (newTera==1) {
    ...
    if (camLeftOff==8) {
      ...
      if (newNano==3) {
        ...
        makeTera(0.5f, 735, 405, 0.5f, true);
      }
    }
    if (camLeftOff==9) {
      noStroke();
    ...
    if (camLeftOff==11) {
      ...
      if (gobo==4) {
        strokeWeight(15);
        stroke(0, 255, 255);
        line(887-100*1.5f*cos(4*PI/3), 317-100*1.5f*sin(4*PI/3), 887-100*1.5f*cos(4*PI/3)+100, 317-100*1.5f*sin(4*PI/3));
        line(887-100*1.5f*cos(2*PI/3), 317-100*1.5f*sin(2*PI/3), 887-100*1.5f*cos(2*PI/3)+100, 317-100*1.5f*sin(2*PI/3));
        rotate(-PI/2);
        makeGobo(1.5f, -317, 887, 1, "Party!", false, false);
        rotate(PI/2);
      } else if (tera==4||tera==5) {
        strokeWeight(15);
        stroke(0, 0, 255/2);
        line(1028, 452, 984, 431);
        makeTera(1.5f, 887, 317, 0.5f, false);
      } else if (newNano==4) {
        strokeWeight(15);
        stroke(139, 69, 19);
        line(1028, 452, 984, 431);
        makeNewNano(1.5f, 887, 317, 1, 0, false, false);
      }
    }
    if (camLeftOff==12) {
      fill(125);
      ...
      if (newTera==4) {
        ...
        makeNewTera(1.5f, 813, 317, 1, 0, 0, false, false);
      } else if (nano==3||nano==4) {
        strokeWeight(15);
        stroke(0, 255/2, 0);
        line(717, 416, 673, 451);
        line(926, 413, 977, 440);
        makeNano(1.5f, 813, 317, 0.5f, 1, false, false);
      } else if (newGiga==5) {
        makeNewGigaHolder(0.5f, 813, 317, 1);
        makeNewGiga(1.5f, 813, 317, 1, false);
      }
    }
    noStroke();
    noFill();
...
public void makeTera(float size, int x, int y, float shade, boolean leg) {
...
public void makeNano(float size, int x, int y, float shade, int eyelids, boolean smile, boolean legs) {
  strokeWeight(10*size);
  ...
  if (eyelids==0) {
    strokeWeight(5*size);
    stroke(0);
    arc(x-50*size, y, 40*size, size*10, 6.5f*PI/5, 8.5f*PI/5);
    arc(x+50*size, y, size*40, 10*size, 6.5f*PI/5, 8.5f*PI/5);
  } else if (eyelids==1) {
    strokeWeight(5*size);
    stroke(0);
    arc(x-50*size, y, 40*size, size*10, 6.5f*PI/5, 8.5f*PI/5);
...
public void makeGobo(float size, int x, int y, float shade, String message, boolean sign, boolean legs) {
  strokeWeight(10*size);
...
public void makePico(float size, int x, int y, float shade, boolean smile, boolean eyeball, boolean legs) {
  strokeWeight(10*size);
  stroke(255*shade, 0, 0);
  if (legs) {
    line(x-100*size*cos(4*PI/3), y-100*size*sin(4*PI/3), x-100*size*cos(4*PI/3), y-100*size*sin(4*PI/3)+100*size);
...
public void makeGiga(float size, int x, int y, float shade, boolean leg) {
  strokeWeight(10*size);
  stroke(50*shade);
  if (leg) {
    line(x-100*size*cos(4*PI/3), y-100*size*sin(4*PI/3), x-100*size*cos(4*PI/3), y-100*size*sin(4*PI/3)+100*size);
...
public void customDayMenu() {
  ...
  makeTera(1, 300, 600, 0.5f, false);
  makeNano(1, 525, 600, 0.5f, 1, false, false);
  makePico(1, 750, 600, 0.5f, false, true, false);
  makeGiga(1, 975, 600, 0.5f, false);
  makeGoldenAlien(1, 1200, 600, 0.5f, false, false);
  stroke(255);
  strokeWeight(5);
  line(297.5f, 100, 297.5f, 400);
  line(522.5f, 100, 522.5f, 400);
  line(747.5f, 100, 747.5f, 400);
  line(972.5f, 100, 972.5f, 400);
  line(1197.5f, 100, 1197.5f, 400);
  line(412.5f, 500, 412.5f, 800);
  line(637.5f, 500, 637.5f, 800);
  line(862.5f, 500, 862.5f, 800);
  line(1087.5f, 500, 1087.5f, 800);
  noStroke();
  textAlign(CENTER);
  fill(255);
...
public void someoneMoved(int cam) {
...
public void j() {
  ...
  if (menuSeconds<120) {
    ...
    if (settings[1]==1) {
      if (whoj=="New Tera") {
        if (menuSeconds<5) {
          makeNewTera(1.5f, 750, 600, 1, 2, 1, false, true);
        } else if (menuSeconds<9) {
          rotate(PI/6);
          makeNewTera(2, 924, 101, 0.8f, 2, 2, true, true);
        } else if (menuSeconds<13) {
          rotate(-PI/12);
          makeNewTera(3, 595, 677, 0.5f, 2, 1, true, true);
        } else if (menuSeconds<17) {
          rotate(PI/6);
          makeNewTera(3.5f, 874, 14, 0.2f, 2, 1, true, true);
        } else if (menuSeconds<21) {
          rotate(-PI/12);
          makeNewTera(5, 620, 580, 0.1f, 2, 1, true, true);
        } else {
          rotate(PI/6);
      ...
      if (whoj=="New Nano") {
        if (menuSeconds<5) {
          makeNewNano(5, 600, 600, 0.5f, 1, true, true);
        } else if (menuSeconds<9) {
          rotate(PI/6);
          makeNewNano(5.5f, 794, 176, 0.4f, 1, true, true);
        } else if (menuSeconds<13) {
          rotate(-PI/6);
          makeNewNano(6, 269, 733, 0.3f, 1, true, true);
        } else if (menuSeconds<17) {
          rotate(PI/6);
          makeNewNano(6.5f, 769, 133, 0.2f, 1, true, true);
        } else if (menuSeconds<21) {
          rotate(-PI/6);
          makeNewNano(6.5f, 269, 733, 0.2f, 1, true, true);
        } else if (menuSeconds<25) {
          rotate(PI/12);
          makeNewNano(7, 708, 327, 0.1f, 1, true, true);
        } else {
          rotate(PI/12);
      ...
      if (whoj=="New Pico") {
        if (menuSeconds<5) {
          ...
          makeNewPico(1.5f, 400, 600, 1, false, true);
        } else if (menuSeconds<13) {
          rotate(-PI/6);
          makeNewPico(2, 96, 633, 1, false, true);
        } else if (menuSeconds<17) {
          rotate(PI/6);
          makeNewPico(2.5f, 400, 350, 1, false, true);
        } else if (menuSeconds<21) {
          makeNewPico(3.5f, 400, 350, 1, false, true);
        } else if (menuSeconds<25) {
          rotate(PI/12);
          makeNewPico(4, 476, 234, 1, false, true);
        } else if (menuSeconds<29) {
          rotate(PI/12);
          makeNewPico(5, 608, 53, 0.5f, true, true);
        } else if (menuSeconds<33) {
          rotate(-PI/4);
          makeNewPico(10, 633, 532, 0.2f, true, true);
        } else {
      ...
      if (whoj=="New Giga") {
        ...
        if (menuSeconds<5) {
          ...
          makeNewGiga(1.5f, 750, 350, 1, false);
        } else if (menuSeconds<13) {
      ...
      if (whoj=="Giga") {
        if (menuSeconds<5) {
          makeGiga(2, 750, 400, 0.4f, true);
        } else if (menuSeconds<9) {
          makeGiga(3, 700, 400, 0.35f, true);
        } else if (menuSeconds<13) {
          makeGiga(5, 700, 400, 0.35f, true);
        } else if (menuSeconds<15) {
          rotate(-PI/24);
          makeGiga(5.5f, 654, 388, 0.35f, true);
        } else if (menuSeconds<17) {
          rotate(-PI/12);
          makeGiga(6, 572, 567, 0.35f, true);
        } else if (menuSeconds<21) {
          rotate(-PI/8);
          makeGiga(6.5f, 531, 545, 0.25f, true);
        } else if (menuSeconds<23) {
          rotate(-PI/6);
          makeGiga(7, 406, 696, 0.2f, true);
        } else if (menuSeconds<25) {
          rotate(-5*PI/24);
          makeGiga(8.5f, 372, 664, 0.15f, true);
        } else if (menuSeconds<27) {
          rotate(-PI/4);
          makeGiga(10, 282, 707, 0.1f, true);
        } else {
          rotate(-PI/4);
      ...
      if (whoj=="Tera") {
        if (menuSeconds<5) {
          makeTera(2, 700, 700, 0.5f, true);
        } else if (menuSeconds<9) {
          makeTera(3, 700, 600, 0.5f, true);
        } else if (menuSeconds<13) {
          makeTera(4, 700, 450, 0.5f, true);
        } else if (menuSeconds<17) {
          makeTera(5, 650, 450, 0.5f, true);
        } else if (menuSeconds<21) {
          makeTera(8, 600, 450, 0.3f, true);
        } else if (menuSeconds<25) {
          makeTera(14, 550, 450, 0.1f, true);
        } else {
      ...
      if (whoj=="Nano") {
        if (menuSeconds<5) {
          makeNano(2, 600, 600, 0.5f, 0, true, true);
        } else if (menuSeconds<9) {
          makeNano(2.5f, 600, 550, 0.5f, 0, true, true);
        } else if (menuSeconds<13) {
          makeNano(4, 600, 450, 0.5f, 0, true, true);
        } else if (menuSeconds<17) {
          makeNano(6, 600, 450, 0.5f, 0, true, true);
        } else if (menuSeconds<21) {
          rotate(PI/12);
          makeNano(6, 696, 279, 0.4f, 0, true, true);
        } else if (menuSeconds<25) {
          rotate(PI/18);
          makeNano(7, 669, 338, 0.2f, 0, true, true);
        } else {
          rotate(-PI/12);
          makeNano(8, 463, 589, 0.05f, 2, true, true);
        }
      }
      if (whoj=="Pico") {
        if (menuSeconds<5) {
          rotate(-PI/12);
          makePico(1.5f, 714, 812, 0.5f, true, true, true);
        } else if (menuSeconds<9) {
          rotate(-PI/12);
          makePico(3, 630, 738, 0.5f, true, true, true);
        } else if (menuSeconds<13) {
          makePico(4, 650, 400, 0.3f, true, true, true);
        } else if (menuSeconds<17) {
          rotate(PI/12);
          makePico(5, 731, 218, 0.2f, true, true, true);
        } else if (menuSeconds<21) {
          rotate(-PI/12);
          makePico(5, 524, 554, 0.1f, true, true, true);
        } else if (menuSeconds<25) {
          makePico(6, 650, 400, 0.1f, true, true, true);
        } else {
          rotate(PI/12);
      ...
      if (whoj=="GS") {
        if (menuSeconds<5) {
          makeGoldenAlien(1.5f, 750, 400, 0.5f, true, false);
        } else if (menuSeconds<9) {
          makeGoldenAlien(2, 750, 400, 0.5f, true, false);
        } else if (menuSeconds<13) {
          makeGoldenAlien(2.5f, 750, 400, 0.4f, true, false);
        } else if (menuSeconds<17) {
          makeGoldenAlien(3, 750, 400, 0.3f, true, false);
        } else if (menuSeconds<21) {
          makeGoldenAlien(3.5f, 750, 400, 0.2f, true, false);
        } else {
          makeGoldenAlien(4, 750, 400, 0.1f, true, false);
        }
      }
      if (whoj=="puppet") {
        if (menuSeconds<5) {
          makePuppet(1, 750, 200, 0.5f, true, false);
        } else if (menuSeconds<9) {
          makePuppet(2, 750, 300, 0.5f, true, false);
        } else if (menuSeconds<13) {
          makePuppet(3, 750, 400, 0.4f, true, false);
        } else if (menuSeconds<17) {
          makePuppet(5, 750, 400, 0.3f, true, false);
        } else if (menuSeconds<21) {
          makePuppet(7, 750, 400, 0.1f, true, false);
        } else {
...
public void deathTimerAI() {
  if (deathTimer>0&&camera==false||deathTimer>15) {
    gameStage=7;
  }
}
public void newPicoAI() {
...
public void disableHallLight() {
  alienWaitTime[19]=ingameSeconds;
}
public void piconianTimer() {
  if (piconianTimer>0) {
    if (ingameSeconds%60==15) {
      piconianTimer++;
    }
...
public void makeNewPico(float size, int x, int y, float shade, boolean smile, boolean leg) {
  strokeWeight(10*size);
...
public void makeNewTera(float size, int x, int y, float shade, int size2, int eyeState, boolean smile, boolean leg) { 
  strokeWeight(10*size);
...
public void makeNewGiga(float size, int x, int y, float shade, boolean holder) {
  if (holder) {
...
public void makeNewGigaHolder(float size, int x, int y, float shade) {
  noFill();
  strokeWeight(10*size);
  stroke(0, 0, 255*shade);
...
public void makeNewNano(float size, int x, int y, float shade, int eyelids, boolean smile, boolean leg) {
  strokeWeight(10*size);
...
public void makePuppet(float size, int x, int y, float shade, boolean body, boolean col) {
  strokeWeight(20*size);
  stroke(0);
  if (body) {
    line(x, y+60*size/1.5f, x+130*size/1.5f, y+20*size/1.5f);
    line(x, y+60*size/1.5f, x-130*size/1.5f, y+20*size/1.5f);
    line(x, y+60*size/1.5f, x, y+220*size/1.5f);
    line(x, y+220*size/1.5f, x+130*size/1.5f, y+320*size/1.5f);
    line(x, y+220*size/1.5f, x-130*size/1.5f, y+320*size/1.5f);
  }
  noStroke();
  fill(255*shade);
...
public void makeGoldenAlien(float size, int x, int y, float shade, boolean smile, boolean legs) {
  strokeWeight(10*size);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "attack_of_the_aliens_2" };
    if (passedArgs != null) {
